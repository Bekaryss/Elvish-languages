...
public class LecturesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(lectureList.size() == 0) {
            prepareLecturess(currentBook.id);
        }
    }
