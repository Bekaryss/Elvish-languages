...
import com.liverkick.elven.activity.QuizActivity;
    ...
    public void GetDataFirebase() {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                List<Question> newList = dataSnapshot.getValue(t);
                ((QuizActivity)context).quesList.addAll(newList);
                ((QuizActivity)context).InitQuestion();
            }
